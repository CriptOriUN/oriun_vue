        ...
        <div class="row mt-5 justify-content-center">
          ...
          <div class="col-md-5 col-lg-7">
            ...
            <div class="row espacios ml-4 mr-4 d-flex bd-highlight">
              <div class="loc flex-fill bd-highlight p-5">
                <h4 class="localizaciones">Cancha de futbol</h4>
              </div>
              <div class="loc flex-fill bd-highlight p-5">
                <h4 class="localizaciones">Cancha de futbol</h4>
              </div>
...
export default {
  ...
  mounted() {
    ...
    let calendar_days_hover = calendar.querySelector(".calendar-day-hover");
    let calendar_days = calendar.querySelector(".calendar-days");

    functioncalendar_days_hover.onclick = () => {
      //  console.log(curr_month.value, curr_year.value);
      console.log("mask off");
    };

    calendar_days.onclick = () => {
      //  console.log(curr_month.value, curr_year.value);
      calendar_days.onclick = null;
    };
  },
};
</script>
