  ...
  <div class="createevent">
    ...
    <div class="plantilla">
      <div class="container contenedor_p">
        ...
        <div class="row my-5">
          <div class="col">
            <h3 class="titulo_lugares titulo_bln titulos">
              Lugares Disponibles
            </h3>
          </div>
        </div>
        ...
        <div class="row py-4 seccion">
          ...
          >
            ...
            <button
              v-on:click="eventLoc(loc.name_LOCATION)"
              class="nombre-lugar"
              id="button"
            >
              {{ loc.name_LOCATION }}
    ...
    submitEventForm: function() {
      ...
      if (
        ...
        this.eventForm.event_INIT_HOUR = this.eventForm.event_INIT_HOUR.concat(
          ...
          this.eventForm.event_FINISH_HOUR = this.eventForm.event_FINISH_HOUR.substring(0,8);
         this.eventForm.event_INIT_HOUR = this.eventForm.event_INIT_HOUR.substring(0,8);
        //   console.log(JSON.stringify(this.eventForm));
