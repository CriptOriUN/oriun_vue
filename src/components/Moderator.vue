              ...
              <div class="card-body">
                ...
                <div class="table-responsive float-right col-7">
                  ...
                  >
                    ...
                    <tbody>
                      <tr>
                        <td ref="suggestedSport">Cartas</td>
                        <td>3</td>
                        <td>
                          <!-- <button v-on:click="addSport()" class="btn btn-primary" title="Añadir"> -->
                      ...
                      <tr>
                        <td>
                          Estoy probando un nombre de deporte sugerido que es
                          muy largo, espero que quepa en el campo de la tabla
                        </td>
                        <td>0</td>
                        <td>
                          <button class="btn btn-primary" title="Añadir">
...
export default {
  ...
  methods: {
    //  addSport(){
    //     axios.post("http://localhost:8081/g/", this.$refs.suggestedSport.innerHTML)
    //       .then(console.log("Suggested Sport: " + this.$refs.suggestedSport.innerHTML))
    //     // console.log(this.$refs.suggestedSport.innerHTML)
    //       // .then((result)=>{
    //       //     this.$emit(this.suggestedSport)
    //       //   })
