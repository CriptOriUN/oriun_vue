    ...
    <div class="navigation">
        ...
        <div class="container">
            <a href="#" class="navbar-brand">
                <img class="logo navbar-brand " v-bind:src="'https://i.ibb.co/ScF3rnx/oriun.png'" alt=" ">
            </a>
            ...
            <div class="collapse navbar-collapse " id="navbar">
                <ul class="navbar-nav d-flex justify-content-end">
                    <li class="nav-item mx-4 active">
                        ...
                        <a href="# " class="nav-link btn-menu">Home<span class="sr-only ">(Actual)</span></a>
                        <!-- </router-link> -->
                    </li>
                    <li class="nav-item mx-4">
                        <!-- <router-link to="/" id="products-link"> -->
                        <a href="# " class="nav-link btn-menu">Eventos</a>
                        <!-- </router-link> -->
                    </li>
                    <li class="nav-item  mx-4">
                        <!-- <router-link :to="{ name: 'CreateEvent', params: { username: this.username }}" id="products-link"> -->
                        <a href="#" class="nav-link btn-menu">Deportes</a>
                        <!-- </router-link> -->
                    </li>
                    <li class="nav-item mx-4 ">
